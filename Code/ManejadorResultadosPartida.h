...
class ManejadorResultadosPartida{//qué vas a hacer, vas a hacer que este invoque al manejador de registros o que ese invoque a éste, indep de que decidas, debes hacer que cuando se envie un restultado de posicion, se muestre en pantalla
    ...
    public:
        void getTotal();//no pongo un getResultados, porque estos se escirbirán directamente al archivo y ahí se mostrará a detalle... y en todo caso si voy a mostrar en pantalla el detalle, lo haré al mismo momento que escribo el dato en el archivo...
};
#endif