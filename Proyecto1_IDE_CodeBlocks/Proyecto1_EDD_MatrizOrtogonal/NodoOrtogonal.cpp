...
class NodoOrtogonal {
    ...
    public://se declaran los prototipos de las funciones, métodos normales y cnstrcs xD
        ...
        void copiarNodo(NodoOrtogonal<T>*);

        NodoOrtogonal<T>* getAnterior();//x1 [izq]
        NodoOrtogonal<T>** getDireccionAnterior();//x1 [izq]
        NodoOrtogonal<T>* getSiguiente();
        NodoOrtogonal<T>** getDireccionSiguiente();
        NodoOrtogonal<T>* getArriba();//y1
        NodoOrtogonal<T>** getDireccionArriba();//y1
        NodoOrtogonal<T>* getAbajo();
        NodoOrtogonal<T>** getDireccionAbajo();
        NodoOrtogonal<T>* getSaliente();
        NodoOrtogonal<T>** getDireccionSaliente();
        NodoOrtogonal<T>* getEntrante();//z2
        NodoOrtogonal<T>** getDireccionEntrante();//z2
        T getContenido();
    ...
    template <class T>
    void NodoOrtogonal<T>::copiarNodo(NodoOrtogonal<T> *nodo){ //[v]
        this->x1 = nodo->getAnterior();
        this->x2 = nodo->getSiguiente();
        this->y1 = nodo->getArriba();
        this->y2 = nodo->getAbajo();
        this->z1 = nodo->getSaliente();
        this->z2 = nodo->getEntrante();
    }
    ...
    template <class T>
    NodoOrtogonal<T>** NodoOrtogonal<T>::getDireccionAnterior(){
        return &x1;
    }
    ...
    template <class T>
    NodoOrtogonal<T>** NodoOrtogonal<T>::getDireccionSiguiente(){
        return &x2;
    }
    ...
    template <class T>
    NodoOrtogonal<T>** NodoOrtogonal<T>::getDireccionArriba(){
        return &y1;
    }
    ...
    template <class T>
    NodoOrtogonal<T>** NodoOrtogonal<T>::getDireccionAbajo(){
        return &y2;
    }
    ...
    template <class T>
    NodoOrtogonal<T>** NodoOrtogonal<T>::getDireccionSaliente(){
        return &z1;
    }
    ...
    template <class T>
    NodoOrtogonal<T>** NodoOrtogonal<T>::getDireccionEntrante(){
        return &z2;
    }
