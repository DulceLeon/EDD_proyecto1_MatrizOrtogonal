...
char ManejadorJuegoDel15::crearElTablero(char tipoCreacion){
    ...
    this->manejadorOrdenamiento->ordenarMatriz(this->manejadorTablero->getTableroOriginal()->getMatrizOrtogonal());//sino pues con el tablero original y si ninguna no, entonces que se envíe el valor... creo que eso hacía antes al enviar tablero para crearlo manualmente...
    cout<<"\nMATRIZ ORDENADA\n";
